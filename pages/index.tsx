...
export default function Home() {
	return (
		<div className="flex flex-col h-full bg-[url('/mer.jpg')] bg-bottom bg-cover">
			<Head>
			...
			<main className='grow'>
				<div className='flex flex-col items-center h-full'>
					<Tab.Group>
						...
						<Tab.Panels className=' bg-stone-900 bg-opacity-70 h-full  max-w-[900px] w-full p-2 sm:p-4 my-6'>
